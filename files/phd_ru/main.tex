...
\cvrow{Научные\\интересы}{%
  ...
  \textbf{технологий повышения конфиденциальности}. Я программирую на \textbf{Go},
  \textbf{Python} и \textbf{TypeScript};  а также имею базовый опыт работы с
  \textbf{C++} и \textbf{Rust}. В особенности меня интересуют формальный анализ безопасности
  и разработка систем для приватного поиска, извлечения и обработки данных на
  основе \textbf{гомоморфного шифрования}
}
...
\cvrow{Научный\\опыт}{%
  ...
  \begin{itemize}
    ...
    \item Разработал модель угроз с честным, но любопытным противником (HBC) и
  ...
  \textbf{Приватная агрегация для федеративного обучения с подкреплением}\par
  \begin{itemize}
    \item Участвовал в разработке TWAPPA-FRL, объединяющей доверительно-взвешенную
    агрегацию (TWA) и гомоморфную агрегацию с сохранением конфиденциальности (PPA)
  ...
  \begin{itemize}
    ...
    шифрования с возможностью поиска на основе забывчивой передачи и ослабленной OPRF,
