...
\vspace{0.08em}
{\large\bfseries Инженер-программист в области ИИ/LLM}\par
\vspace{0.22em}
\hrule
\vspace{0.55em}
...
\cvrow{Навыки}{%
  \begin{tabularx}{\linewidth}
    ...
    &
    \skillcell{Инженерия ИИ/LLM:}{%
      LangChain, RAG, агенты,
      оркестрация LLM}
    \\[0.20em]

    \skillcell{Приложения и данные:}{%
      FastAPI, Flask, AsyncIO, REST API,
      Next.js, PostgreSQL, Redis, S3}
    &
    \skillcell{Инженерия безопасности:}{%
      YARA, анализ вредоносного ПО, анализ IoC/TTP,
      MITRE ATT\&CK}
    \\[0.20em]
