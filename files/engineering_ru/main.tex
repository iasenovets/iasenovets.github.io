...
\cvrow{}{%
  ...
  \workproject{Реализовал REST API на Python и конвейер генерации курсов на 
  базе LangChain с использованием асинхронной оркестрации LLM.}
  \workproject{Разработал слой приложения на Next.js, TypeScript,
  Prisma и Auth.js, включая аутентификацию и хранение данных курсов и пользователей.}
