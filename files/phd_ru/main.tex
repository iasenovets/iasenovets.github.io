...
\cvrow{Научный\\опыт}{%
  ...
  \begin{itemize}
    ...
    \item Объединил взвешивание клиентов на основе доверия с гомоморфной агрегацией
    обновлений федеративной модели и расшифрованием только агрегированного результата отдельным центром управления ключами,
