...
\cvrow{Профиль}{%
  ...
  и прикладной криптографии. Разрабатываю на \textbf{Go},
  \textbf{Python} и \textbf{TypeScript}; имею базовый опыт работы
  с \textbf{C++} и \textbf{Rust}. Работал над криптографическими
  протоколами, системами приватного поиска и обработки данных.
}
...
\cvrow{Навыки}{%
  \begin{tabularx}{\linewidth}
    ...
    \skillcell{Языки:}{%
      русский --- родной;
      \href{https://certs.duolingo.com/751e0ef152565727b6d5fd909699ceaa}{английский --- C1};
...
\cvrow{Опыт работы}{%
  ...
  \workproject{\textbf{BGV-PIR для Hyperledger Fabric}}
  ...
  \workproject{\textbf{Приватная агрегация для федеративного обучения}}
  \workprojectdetail{Участвовал в разработке TWAPPA-FRL, объединяющей
  доверительно-взвешенную агрегацию (TWA) и CKKS-агрегацию с сохранением
  ...
  \workproject{\textbf{Верифицируемое многоключевое SSE}}
  \workprojectdetail{Участвовал в разработке EVMK-SSE --- эффективной схемы
  многоключевого шифрования с возможностью поиска на основе OT и ослабленной OPRF,
